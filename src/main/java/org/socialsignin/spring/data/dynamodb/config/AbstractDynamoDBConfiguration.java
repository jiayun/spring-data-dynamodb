...
public abstract class AbstractDynamoDBConfiguration {
	...
	/**
	 * Return the base packages to scan for mapped {@link DynamoDbBean}s. Will
	 ...
	 * alternate behaviour.
	 *
	 * @return the base package to scan for mapped {@link DynamoDbBean} classes or
	 ...
	 *             if the class with {@link DynamoDbBean} annotation can't be
	 *             loaded
	 */
	@Bean
