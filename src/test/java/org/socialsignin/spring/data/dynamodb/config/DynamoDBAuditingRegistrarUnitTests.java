...
public class DynamoDBAuditingRegistrarUnitTests {
	...
	public void rejectsNullAnnotationMetadata() {
		assertThrows(IllegalArgumentException.class, () -> registrar.registerBeanDefinitions(null, registry));
	}

	@Test
	public void rejectsNullBeanDefinitionRegistry() {
		assertThrows(IllegalArgumentException.class, () -> registrar.registerBeanDefinitions(metadata, null));
	}
}
