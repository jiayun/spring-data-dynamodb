...
public class User {
	...
	@DynamoDbConvertedBy(value = DynamoDBYearMarshaller.class)
    ...
    @SuppressWarnings("deprecation")
	@DynamoDbConvertedBy(value = Instant2IsoDynamoDBMarshaller.class)
	...
	@DynamoDbSecondaryPartitionKey(indexNames = {"idx_postCode_numberOfPlaylist"})
	...
	@DynamoDbSecondarySortKey(indexNames = {"idx_postCode_numberOfPlaylist"})
