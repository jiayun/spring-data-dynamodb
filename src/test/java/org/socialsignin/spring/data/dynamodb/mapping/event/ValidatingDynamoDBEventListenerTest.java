...
public class ValidatingDynamoDBEventListenerTest {
	...
	public void testWrongConstructor() {
		assertThrows(IllegalArgumentException.class, () -> new ValidatingDynamoDBEventListener(null),
	...
	public void testValidationException() {
		...
		ConstraintViolationException exception =
				assertThrows(ConstraintViolationException.class, () -> underTest.onBeforeSave(sampleEntity));
		assertTrue(exception.getMessage().contains("Test Validation Exception 1"));
		assertTrue(exception.getMessage().contains("Test Validation Exception 2"));
	}
}
